...
<body>
  <div class="head">
    ...
    <span class="badge" style="background:rgba(0,245,200,.12);color:#00F5C8;border:1px solid rgba(0,245,200,.3)">3.13e - Cadre R bimodal · 40 sym <span style="opacity:.6;font-weight:600">· WR ~49% · +0.6R/trade</span></span>
    <span id="mode" class="badge net">TESTNET</span>
    <span id="run" class="badge off">PAUSE</span>
  </div>
  <div class="sub" id="stratline">3.13e-Cadre R bimodal · mode volatil 1R>5% (0.4R/60%/-0.6R/0.25R) · risque/trade ≤1.2% · stop 1.5 ATR · partiel 50% +1R · trail 0.5R · paliers de mise · garde friction · verrou d'entrée · bonus Q70+ x9 · zéro rotation</div>
...
<script>
  ...
  function renderStats(s){
    ...
    $('stratline').textContent='3.13e-Cadre R bimodal · mode volatil 1R>5% (partiel 0.4R·60% / stop -0.6R / trail 0.25R) · risque/trade ≤1.2% cap · stop 1.5×ATR(14) · partiel 50% à +1R puis break-even · trail 0.5R · paliers de mise par capital + modulation ATR · garde friction 6× · bonus loterie Q70+ 25-50$ x9 SL-5% · zéro rotation · multi-régime · x2-5';
...
async function start() {
  logLine(`\u{1F680} Itachi — SERVEUR 3.13e-Cadre R BIMODAL (mode volatil 1R>5% / persistance state.json / garde fraicheur 15s / stats.csv — decrets Calvin 08/08) — ${MODE.toUpperCase()} — capital $${CAPITAL_START}`);
  logLine(`\u{1F4C8} 3.13e-Cadre R BIMODAL — calme : partiel 1R/50%, trail 0.5R — volatil (1R>5%) : partiel 0.4R/60%, stop -0.6R, trail 0.25R — risque <= 1.2% cap — persistance + fraicheur + /stats.csv — bonus x9 intouche`);
