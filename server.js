/* ============================================================
 *  SERVEUR 3.12d - CHAMPION  (connexion DASHBOARD — strategie 3.12b INTACTE)
 *  ------------------------------------------------------------
...
<body>
  <div class="head">
    ...
    <span class="badge" style="background:rgba(0,245,200,.12);color:#00F5C8;border:1px solid rgba(0,245,200,.3)">3.12d - Champion · 40 sym <span style="opacity:.6;font-weight:600">· WR ~70%</span></span>
    <span id="mode" class="badge net">TESTNET</span>
    <span id="run" class="badge off">PAUSE</span>
  </div>
  <div class="sub" id="stratline">3.12d-Champion · connexion dashboard · SL -4.5% (optimisé) · trailing +1%/-1.5% · bonus loterie · multi-régime</div>
...
<script>
  ...
  function renderStats(s){
    ...
    $('stratline').textContent='3.12d-Champion · SL -'+(s.strat?s.strat.sl.toFixed(1):4.5)+'% (optimisé backtest) · trailing +'+(s.strat?s.strat.trailArm:1)+'%/-'+(s.strat?s.strat.trailPct:1.5)+'% · bonus loterie 25-50$ x15 · laisse courir 24h · multi-régime (RANGE→MR / UP→long / DOWN→short) · x2-5';
...
async function start() {
  logLine(`\u{1F680} Itachi — SERVEUR 3.12d-Champion (connexion dashboard — strategie 3.12b intacte) — ${MODE.toUpperCase()} — capital $${CAPITAL_START}`);
  logLine(`\u{1F4C8} 3.12d-Champion — SL -4.5% (optimise) / trailing +1%/-1.5% — bonus loterie 25-50$ x15 sans SL — x2-5 — mise 80-280$ — 25 pos — seuils +15%`);
